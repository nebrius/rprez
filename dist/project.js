...
function loadProject(pathToProjectFile) {
    return __awaiter(this, void 0, void 0, function* () {
        const presentationFileExists = yield util_1.promisify(fs_1.exists)(pathToProjectFile);
        if (!presentationFileExists) {
            throw new Error(`Presentation file ${pathToProjectFile} does not exist`);
        }
        let data;
        try {
            data = yield readFile(pathToProjectFile);
        }
        catch (err) {
